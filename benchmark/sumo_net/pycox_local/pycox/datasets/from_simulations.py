...
import numpy as np
import pandas as pd
from benchmark.sumo_net.pycox_local.pycox import simulations
from benchmark.sumo_net.pycox_local.pycox.datasets._dataset_loader import _DatasetLoader
...
class _RRNLNPH(_SimDataset):
    ...
    The dataset is created with `pycox_local.simulations.SimStudyNonLinearNonPH` (see
    ...
    To generate more data:
        >>> from benchmark.sumo_net.pycox_local.simulations import SimStudyNonLinearNonPH
        >>> n = 10000
...
class _SAC3(_SimDataset):
    ...
    The dataset is created with `pycox_local.simulations.SimStudySACConstCensor`
    ...
    To generate more data:
        >>> from benchmark.sumo_net.pycox_local.simulations import SimStudySACCensorConst
        >>> n = 10000
...
class _SACAdmin5(_SimDataset):
    ...
    To generate more data:
        >>> from benchmark.sumo_net.pycox_local.simulations import SimStudySACAdmin
        >>> n = 10000
